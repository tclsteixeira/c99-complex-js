...
describe("Complex.floor", () => {
  ...
  it("computes floor(0 + 0i) correctly", () => {
  ...
  // Test 5: NaN input
  it("computes floor(NaN + NaNi) correctly", () => {
  ...
  it("computes floor(∞ + 3.7i) correctly", () => {
  ...
  it("computes floor(1e-10 + 1e-10i) correctly", () => {
  ...
  it("computes floor(NaN + 3.7i) correctly", () => {
